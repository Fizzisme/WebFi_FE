...
import { Button } from '@/components/ui/button' // Giả sử bạn có Shadcn Button, hoặc dùng thẻ button thường
            ...
            <div className="w-full max-w-[1200px] border-x border-gray-100 min-h-screen pb-20">
                ...
                <div className="relative px-4 pt-3 pb-2">
                    ...
                    <div className="mt-2">
                        ...
                        {/* Bio */}
                        <p className="mt-3 text-[15px] text-gray-900 leading-normal">This product was built by me</p>
